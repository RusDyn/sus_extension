...
[Download the ZIP file](https://github.com/RusDyn/sus_extension/releases) from the latest release and save it to a known location on your computer.
...
## How to use the extension
 ...
 You will see the form to enter your OpenAI API keys. You can find them in your [OpenAI dashboard](https://platform.openai.com/account/api-keys). 

 2. **Go to matchmaking platform**
 [Wait for 10 second](https://www.startupschool.org/cofounder-matching/candidate/next) and receive summary and autogenerated reply message 
